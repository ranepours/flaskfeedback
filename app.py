...
from forms import DeleteForm, FeedbackForm, RegisterForm, LoginForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        return render_template(f'/register.html',form=form)
...
def render_user(username):
    ...
    return render_template('render.html',user=user,form=form)
...
def handle_update(feedback_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(f"/users/{feedback.username}")
    return render_template(f"edit_feedback.html",form=form,feedback=feedback)
